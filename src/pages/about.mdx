...
This website was made by [Sean McPherson](https://seanmcp.com), built with [Astro](https://astro.build/), and is hosted on [Netlify](https://www.netlify.com/). The icons are from [HeroIcons](https://heroicons.com/).
